...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col dark:bg-dark-bg">
      {/* Fondo solo en modo claro */}
      <div
        className="absolute inset-0 dark:hidden"
        style={{ backgroundImage: `url(${fondoLogin})`, backgroundSize: "cover", backgroundPosition: "center" }}
      />
      {/* Overlay para legibilidad en modo claro */}
      <div className="absolute inset-0 bg-black/40 dark:hidden" />

      <div className="relative z-10 flex flex-col min-h-screen">
        <Navbar />
        <div className="flex flex-1 items-center justify-center px-4 py-10">
          <div className="bg-white/90 dark:bg-dark-card backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg p-8 w-full max-w-sm">
            <div className="text-center mb-7">
              <img
                src="https://pbs.twimg.com/profile_images/691661000597200897/nOj5fUnN.jpg"
                alt="Escudo Alcaldía de Sampués"
                className="w-14 h-14 rounded-full object-cover mx-auto mb-3 shadow"
              />
